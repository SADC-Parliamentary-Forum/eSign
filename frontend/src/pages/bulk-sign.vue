                ...
                <template v-slot:item.1>
                    <VCard elevation="1" border class="rounded-lg">
                        <VCardText class="pa-8 text-center">
                            ...
                            >
                                <input type="file" ref="fileInput" multiple hidden accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png,.gif,.webp,.bmp,.tiff,.tif" @change="onFileChange" />
                                ...
                                <p class="text-body-2 text-medium-emphasis">PDF, Word, Excel, or images</p>
                            </div>
