...
<body>
    <div class="container">
        ...
        <p>Hello <?php echo e($signerName); ?>,</p>
        <p>Please click the button below to verify your email address and complete your identity verification.</p>
        <a href="<?php echo e($verificationUrl); ?>" class="btn">Verify Email Address</a>
        <p class="url-fallback">Or copy this link into your browser:<br><?php echo e($verificationUrl); ?></p>
...
</html><?php /**PATH /var/www/html/resources/views/emails/verify_signer.blade.php ENDPATH**/ ?>